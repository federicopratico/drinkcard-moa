...
class AdminPaymentControllerTest {
    ...
    void listPayments_WhenPaymentsExist_ShouldReturnPagedPaymentResponse() {
        ...
        assertAll(
                ...
                () -> assertEquals(payment.volunteerId(), paymentResponse.volunteer().id()),
                () -> assertEquals("Ada", paymentResponse.volunteer().firstName()),
                () -> assertEquals("Lovelace", paymentResponse.volunteer().lastName()),
                () -> assertEquals("ada@example.com", paymentResponse.volunteer().email()),
